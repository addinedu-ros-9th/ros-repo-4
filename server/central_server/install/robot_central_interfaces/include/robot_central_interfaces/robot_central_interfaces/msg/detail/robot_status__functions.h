...
#ifndef ROBOT_CENTRAL_INTERFACES__MSG__DETAIL__ROBOT_STATUS__FUNCTIONS_H_
#define ROBOT_CENTRAL_INTERFACES__MSG__DETAIL__ROBOT_STATUS__FUNCTIONS_H_
 ...
 * )) before or use
 * robot_central_interfaces__msg__RobotStatus__create()
 ...
 * calls
 * robot_central_interfaces__msg__RobotStatus__init().
...
/**
 * It calls
 * robot_central_interfaces__msg__RobotStatus__fini()
 ...
 * robot_central_interfaces__msg__RobotStatus__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * robot_central_interfaces__msg__RobotStatus__Sequence__fini()
 * on the array,
...
#endif  // ROBOT_CENTRAL_INTERFACES__MSG__DETAIL__ROBOT_STATUS__FUNCTIONS_H_
