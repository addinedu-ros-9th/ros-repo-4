...
std::shared_ptr<CentralServer> g_server;
...
void printUsageInstructions() {
    std::cout << "\n=== Central Server with Nearest Waypoint Start Point ===" << std::endl;
...
int main(int argc, char** argv)
{
    ...
    try {
        ...
        RCLCPP_INFO(g_server->get_logger(), "Central Server with Nearest Waypoint Start Point");
        RCLCPP_INFO(g_server->get_logger(), "==========================================================");
