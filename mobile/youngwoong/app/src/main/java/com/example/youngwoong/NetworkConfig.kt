...
object NetworkConfig {
    ...
    private const val CENTRAL_SERVER_IP = "192.168.0.36"
    private const val LLM_SERVER_IP = "192.168.0.36" //LLM 서버 IP (별도 설정 가능)
    ...
    // ESP32 IP 주소
    private const val ESP32_IP = "192.168.0.32"
    private const val WEBSOCKET_SERVER_PORT = "3000"
    // URL 생성 함수들
    ...
    fun getGuiWebSocketUrl(): String = "ws://$CENTRAL_SERVER_IP:$WEBSOCKET_SERVER_PORT/?client_type=gui"
    // 개별 엔드포인트 URL들
