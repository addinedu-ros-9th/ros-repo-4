...
| 이름 | 소감 |
|:---:|---|
| 김채연 | 회의와 소통의 중요성을 크게 느낄 수 있었던 프로젝트였습니다. 설계 과정을 통해 많은 걸 배우고, 다양한 시스템을 연동하면서 흥미로운 경험을 쌓을 수 있었습니다. 딥러닝과 통신 테스트 과정도 재미있었고, 특히 개별 테스트와 연동 테스트를 함께 병행해야 한다는 점을 배울 수 있었습니다. | 
| 김범진 | 이번 프로젝트는 팀원들의 헌신으로 완성도를 높일 수 있었습니다. 하드웨어와 디자인 그리고 사비까지 투자해 완성도를 높여주신 원호씨, 가장 어려운 주행을 끝까지 책임진 태호씨, LLM과 중앙 서버를 구축하며 다른 팀원들의 이슈까지 챙겨준 민제씨, 그리고 설계와 문서, 딥러닝 구현까지 맡아 팀장으로서 팀을 이끌어준 채연씨 덕분에 최우수상을 수상할 수 있었고, 짧았지만 한 달간의 프로젝트는 매우 뜻깊고 즐거운 경험이었습니다. |
...
| 김태호 | 자율주행이라는 난생 처음 맡은 분야를 수행하면서 많이 어려웠고 힘들었지만, 팀원들의 도움으로 프로젝트를 완수할 수 있었습니다. 이번 프로젝트를 통해 로봇개발자의 꿈에 한발짝 더 다가간 것 같습니다. | 
